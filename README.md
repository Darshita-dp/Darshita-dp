...
> End-to-end healthcare revenue cycle platform that combines SQL, Python ETL, Power BI, React, FastAPI, and workflow automation to help teams prioritize claims and recover revenue faster.

- Claim denial, payer-performance, and A/R aging analytics
- Explainable 0–100 claim-priority scoring
...
### Patient Access & Appointment No-Show Automation

> Healthcare scheduling decision-support platform that predicts no-show risk, recommends staff actions, and helps clinics recover unused appointment capacity through waitlist matching.

- 0.72 ROC-AUC on temporal holdout
- Risk-based staff recommendations and outreach actions
...
<img src="https://capsule-render.vercel.app/api?type=waving&height=120&color=0:9333EA,50:6D28D9,100:312E81&section=footer" width="100%" alt="Footer banner" />
